...
export class DonService {
  ...
  assignDonation(id: number, beneficiaryId: number) {
    return this.http.put(`${Env.DONATION}${id}/assign?beneficiaryId=${beneficiaryId}`, {});
  }

  reassignDonation(id: number, newBeneficiaryId: number) {
    return this.http.put(`${Env.DONATION}${id}/reassign?newBeneficiaryId=${newBeneficiaryId}`, {});
  }
...
//     descriptionComplete:
//       "Un fauteuil roulant médical, neuf, conçu pour les personnes à mobilité réduite. Doté d'un siège rembourré et de freins performants pour la sécurité.",
//     caracteristiques: [
...
export const DONATION_REQUESTS_MOCK: DonationRequestDTO[] = [
  {
    id: 1,
    message:
      "Nous avons un besoin urgent de ce type d'équipement pour notre centre de rééducation.",
    status: 'PENDING',
  ...
  },
  {
    id: 3,
    message:
      "Nous ouvrons une nouvelle bibliothèque rurale et ces livres sont vitaux pour l'éducation.",
    status: 'APPROVED',
  ...
  },
  {
    id: 5,
    message:
      'Notre centre de formation a besoin de ce four pour les cours de cuisine professionnels.',
    status: 'PENDING',
...
export const MOCK_SOCIAL_ACTIONS: SocialAction[] = [
  {
    titre: 'Sensibilisation au paludisme',
    lieu: 'Gao',
    description: 'Campagne contre le paludisme.',
    imageIds: [],
    passed: true,
  ...
  {
    titre: 'Formation en recyclage',
    lieu: 'Sikasso',
    description: 'Atelier sur la transformation des déchets.',
    imageIds: [],
    passed: true,
  ...
  {
    titre: 'Aide aux déplacés',
    lieu: 'Tombouctou',
    description: 'Distribution de vivres et d’eau potable.',
    imageIds: [],
    passed: false,
  ...
  {
    titre: 'Journée sportive inter-écoles',
    lieu: 'Bamako',
    description: 'Promotion de l’unité et du sport.',
    imageIds: [],
    passed: true,
  ...
  {
    titre: 'Don de vêtements',
    lieu: 'Ségou',
    description: 'Distribution de vêtements aux familles démunies.',
    imageIds: [],
    passed: true,
  ...
  {
    titre: 'Atelier sur l’eau potable',
    lieu: 'Kayes',
    description: 'Éducation sur l’hygiène et l’eau propre.',
    imageIds: [],
    passed: true,
  ...
  {
    titre: 'Recyclage des plastiques',
    lieu: 'Bamako',
    description: 'Nettoyage urbain et tri des déchets.',
    imageIds: [],
    passed: false,
  ...
  {
    titre: 'Soutien psychologique aux victimes',
    lieu: 'Gao',
    description: 'Accompagnement psychologique communautaire.',
    imageIds: [],
    passed: true,
  ...
  {
    titre: 'Séminaire d’entrepreneuriat',
    lieu: 'Bamako',
    description: 'Formation et networking pour jeunes.',
    imageIds: [],
    passed: false,
  ...
  {
    titre: 'Forum de la jeunesse',
    lieu: 'Mopti',
    description: 'Rencontre pour le développement local.',
    imageIds: [],
    passed: true,
